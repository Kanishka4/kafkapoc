...
public class DataRecordAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3870203661573144441L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DataRecordAvro\",\"namespace\":\"com.example.kafkapoc.avro\",\"fields\":[{\"name\":\"count\",\"type\":\"long\"}]}");
   ...
   */
  public static com.example.kafkapoc.avro.DataRecordAvro.Builder newBuilder() {
    return new com.example.kafkapoc.avro.DataRecordAvro.Builder();
  }
   ...
   * @return A new DataRecordAvro RecordBuilder
   */
  public static com.example.kafkapoc.avro.DataRecordAvro.Builder newBuilder(com.example.kafkapoc.avro.DataRecordAvro.Builder other) {
    return new com.example.kafkapoc.avro.DataRecordAvro.Builder(other);
  }
   ...
   * @return A new DataRecordAvro RecordBuilder
   */
  public static com.example.kafkapoc.avro.DataRecordAvro.Builder newBuilder(com.example.kafkapoc.avro.DataRecordAvro other) {
    return new com.example.kafkapoc.avro.DataRecordAvro.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DataRecordAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafkapoc.avro.DataRecordAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafkapoc.avro.DataRecordAvro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.count)) {
        this.count = data().deepCopy(fields()[0].schema(), other.count);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkapoc.avro.DataRecordAvro.Builder setCount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkapoc.avro.DataRecordAvro.Builder clearCount() {
